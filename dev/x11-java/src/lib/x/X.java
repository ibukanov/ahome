...
/* Some general constants */
  ...
  public static final int XPROTOCOL_MAJOR_VERSION = 11;
  public static final int XPROTOCOL_MINOR_VERSION = 0;
  ...
  public static final int PIXEL_SIZE    = INT_SIZE;
  public static final int RGB_SIZE      = 4 * SHORT_SIZE;
  public static final int RGB_WHITE     = 0xFFFFFFFF;
  public static final int RGB_BLACK     = 0xFF000000;
  public static final int BITMAP_DEPTH  = 1;

  public static final int UBYTE_MAX     =  (1 << 8) - 1;
  public static final int BYTE_MIN      = -(1 << 7);
  public static final int BYTE_MAX      =  (1 << 7) - 1;
  public static final int USHORT_MAX    =  (1 << 16) - 1;
  public static final int SHORT_MIN     = -(1 << 15);
  public static final int SHORT_MAX     =  (1 << 15) - 1;

  public static final byte      UNUSED_BYTE     = 0;
  public static final short     UNUSED_SHORT    = 0;
  public static final int       UNUSED_INT      = 0;
  public static final boolean   UNUSED_BOOLEAN  = false;

  public static final int ID_NONE               = 0;
  public static final int COPY_ID_FROM_PARENT   = 0;

  static final int MAX_REQUEST_SIZE = USHORT_MAX * INT_SIZE;

  static final int ERROR_OPCODE = 0;
  static final int REPLY_OPCODE = 1;
  static final int REPLY_DATA_SIZE_OFFSET = 4;
  static final int REPLY_NUMBER_OFFSET = 2;
  
  public static final int MIN_REPLY_LENGTH = 32;
  public static final int EVENT_LENGTH = MIN_REPLY_LENGTH;
  public static final int ERROR_LENGTH = MIN_REPLY_LENGTH;

/* The following constants can significantly affect the performance */

// The test case
//   public static final int MAX_REPLIES_IN_BUF            = 2;
//   public static final int OUTPUT_BUF_SIZE               = 1 << 2;
//   public static final int ID_STORE_CAPACITY_INCREMENT   = 1;

// The normal case
  public static final int MAX_REPLIES_IN_BUF            = 256;
  public static final int OUTPUT_BUF_SIZE               = 1 << 13;
  public static final int ID_STORE_CAPACITY_INCREMENT   = 5;

  public static final int MAX_EVENTS_IN_BUF = MAX_REPLIES_IN_BUF;
  public static final int MAX_ERRORS_IN_BUF = MAX_REPLIES_IN_BUF;
  public static final int INPUT_BUF_SIZE    = MIN_REPLY_LENGTH 
                                              * MAX_REPLIES_IN_BUF;

/* Internal constants */
  static final int IMAGE_FORMAT_BITMAP      = 0;
  static final int IMAGE_FORMAT_XY_PIXMAP   = 1;
  static final int IMAGE_FORMAT_Z_PIXMAP    = 2;
  
  static final boolean WAIT_SERVER_ANSWER   = true;
  static final boolean ASYNCHRONOUS_REQUEST = false;

/* Request List */
  static final int CREATE_WINDOW_REQUEST            = 1;
  static final int CHANGE_WINDOW_ATTRIBUTES_REQUEST = 2;
  static final int DESTROY_WINDOW_REQUEST           = 4;
  static final int MAP_WINDOW_REQUEST               = 8;
  static final int UNMAP_WINDOW_REQUEST             = 10;
  static final int CONFIGURE_WINDOW_REQUEST         = 12;

  static final int INTERN_ATOM_REQUEST              = 16;
  static final int GET_ATOM_NAME_REQUEST            = 17;
  static final int CHANGE_PROPERTY_REQUEST          = 18;
  static final int DELETE_PROPERTY_REQUEST          = 19;
  static final int GET_PROPERTY_REQUEST             = 20;
  static final int LIST_PROPERTIES_REQUEST          = 21;
  
  static final int OPEN_FONT_REQUEST                = 45;
  static final int CLOSE_FONT_REQUEST               = 46;
  static final int QUERY_FONT_REQUEST               = 47;

  static final int CREATE_PIXMAP_REQUEST            = 53;
  static final int FREE_PIXMAP_REQUEST              = 54;
 
  static final int CREATE_GC_REQUEST                = 55;
  static final int CHANGE_GC_REQUEST                = 56;
  static final int SET_CLIP_RECTANGLES_REQUEST      = 59;
  static final int FREE_GC_REQUEST                  = 60;
  static final int COPY_AREA_REQUEST                = 62;
  static final int POLY_POINT_REQUEST               = 64;
  static final int POLY_LINE_REQUEST                = 65;
  static final int POLY_SEGMENT_REQUEST             = 66;
  static final int POLY_RECTANGLE_REQUEST           = 67;
  static final int POLY_ARC_REQUEST                 = 68;
  static final int FILL_POLY_REQUEST                = 69;
  static final int POLY_FILL_RECTANGLE_REQUEST      = 70;
  static final int POLY_FILL_ARC_REQUEST            = 71;
  static final int PUT_IMAGE_REQUEST                = 72;
  static final int GET_IMAGE_REQUEST                = 73;
  static final int POLY_TEXT8_REQUEST               = 74;
  static final int POLY_TEXT16_REQUEST              = 75;

  static final int CREATE_COLORMAP_REQUEST          = 78;
  static final int FREE_COLORMAP_REQUEST            = 79;
  static final int ALLOC_COLOR_REQUEST              = 84;
  static final int FREE_COLORS_REQUEST              = 88;
  static final int QUERY_COLORS_REQUEST             = 91;

  static final int CREATE_CURSOR_REQUEST            = 93;
  static final int CREATE_GLYPH_CURSOR_REQUEST      = 94;
  static final int FREE_CURSOR_REQUEST              = 95;
  static final int RECOLOR_CURSOR_REQUEST           = 96;

  static final int GET_KEYBOARD_MAPPING_REQUEST     = 101;
  static final int SET_MODIFIER_MAPPING_REQUEST     = 118;
  static final int GET_MODIFIER_MAPPING_REQUEST     = 119;


/* Standard atom definitions and related constants */
  static final int XA_ANY_PROPERTY_TYPE     = 0;
  
  static final int XA_PRIMARY               = 1;
  static final int XA_SECONDARY             = 2;
  static final int XA_ARC                   = 3;
  static final int XA_ATOM                  = 4;
  static final int XA_BITMAP                = 5;
  static final int XA_CARDINAL              = 6;
  static final int XA_COLORMAP              = 7;
  static final int XA_CURSOR                = 8;
  static final int XA_CUT_BUFFER0           = 9;
  static final int XA_CUT_BUFFER1           = 10;
  static final int XA_CUT_BUFFER2           = 11;
  static final int XA_CUT_BUFFER3           = 12;
  static final int XA_CUT_BUFFER4           = 13;
  static final int XA_CUT_BUFFER5           = 14;
  static final int XA_CUT_BUFFER6           = 15;
  static final int XA_CUT_BUFFER7           = 16;
  static final int XA_DRAWABLE              = 17;
  static final int XA_FONT                  = 18;
  static final int XA_INTEGER               = 19;
  static final int XA_PIXMAP                = 20;
  static final int XA_POINT                 = 21;
  static final int XA_RECTANGLE             = 22;
  static final int XA_RESOURCE_MANAGER      = 23;
  static final int XA_RGB_COLOR_MAP         = 24;
  static final int XA_RGB_BEST_MAP          = 25;
  static final int XA_RGB_BLUE_MAP          = 26;
  static final int XA_RGB_DEFAULT_MAP       = 27;
  static final int XA_RGB_GRAY_MAP          = 28;
  static final int XA_RGB_GREEN_MAP         = 29;
  static final int XA_RGB_RED_MAP           = 30;
  static final int XA_STRING                = 31;
  static final int XA_VISUALID              = 32;
  static final int XA_WINDOW                = 33;
  static final int XA_WM_COMMAND            = 34;
  static final int XA_WM_HINTS              = 35;
  static final int XA_WM_CLIENT_MACHINE     = 36;
  static final int XA_WM_ICON_NAME          = 37;
  static final int XA_WM_ICON_SIZE          = 38;
  static final int XA_WM_NAME               = 39;
  static final int XA_WM_NORMAL_HINTS       = 40;
  static final int XA_WM_SIZE_HINTS         = 41;
  static final int XA_WM_ZOOM_HINTS         = 42;
  static final int XA_MIN_SPACE             = 43;
  static final int XA_NORM_SPACE            = 44;
  static final int XA_MAX_SPACE             = 45;
  static final int XA_END_SPACE             = 46;
  static final int XA_SUPERSCRIPT_X         = 47;
  static final int XA_SUPERSCRIPT_Y         = 48;
  static final int XA_SUBSCRIPT_X           = 49;
  static final int XA_SUBSCRIPT_Y           = 50;
  static final int XA_UNDERLINE_POSITION    = 51;
  static final int XA_UNDERLINE_THICKNESS   = 52;
  static final int XA_STRIKEOUT_ASCENT      = 53;
  static final int XA_STRIKEOUT_DESCENT     = 54;
  static final int XA_ITALIC_ANGLE          = 55;
  static final int XA_X_HEIGHT              = 56;
  static final int XA_QUAD_WIDTH            = 57;
  static final int XA_WEIGHT                = 58;
  static final int XA_POINT_SIZE            = 59;
  static final int XA_RESOLUTION            = 60;
  static final int XA_COPYRIGHT             = 61;
  static final int XA_NOTICE                = 62;
  static final int XA_FONT_NAME             = 63;
  static final int XA_FAMILY_NAME           = 64;
  static final int XA_FULL_NAME             = 65;
  static final int XA_CAP_HEIGHT            = 66;
  static final int XA_WM_CLASS              = 67;
  static final int XA_WM_TRANSIENT_FOR      = 68;

/* GC attributes flags */
  public static final int SET_GC_FUNCTION      = 0x00000001; 
  public static final int SET_GC_FOREGROUND    = 0x00000004; 
  public static final int SET_GC_FONT          = 0x00004000; 
  public static final int SET_GC_CLIP_X_ORIGIN = 0x00020000; 
  public static final int SET_GC_CLIP_Y_ORIGIN = 0x00040000; 
  public static final int SET_GC_CLIP_BITMAP   = 0x00080000; 

  public static final int GC_FUNCTION_COPY = 3;
  public static final int GC_FUNCTION_XOR  = 6;
  public static final int GC_CLIPPING_NONE = 0;

/* Event type selector masks */
  public static final int KEY_PRESS_EVENT_MASK              = 1 <<  0;
  public static final int KEY_RELEASE_EVENT_MASK            = 1 <<  1;
  public static final int BUTTON_PRESS_EVENT_MASK           = 1 <<  2;
  public static final int BUTTON_RELEASE_EVENT_MASK         = 1 <<  3;
  public static final int ENTER_WINDOW_EVENT_MASK           = 1 <<  4;
  public static final int LEAVE_WINDOW_EVENT_MASK           = 1 <<  5;
  public static final int POINTER_MOTION_EVENT_MASK         = 1 <<  6;
  public static final int POINTER_MOTION_HINT_EVENT_MASK    = 1 <<  7;
  public static final int BUTTON1_MOTION_EVENT_MASK         = 1 <<  8;
  public static final int BUTTON2_MOTION_EVENT_MASK         = 1 <<  9;
  public static final int BUTTON3_MOTION_EVENT_MASK         = 1 << 10;
  public static final int BUTTON4_MOTION_EVENT_MASK         = 1 << 11;
  public static final int BUTTON5_MOTION_EVENT_MASK         = 1 << 12;
  public static final int BUTTON_MOTION_EVENT_MASK          = 1 << 13;
  public static final int KEYMAP_STATE_EVENT_MASK           = 1 << 14;
  public static final int EXPOUSURE_EVENT_MASK              = 1 << 15;
  public static final int VISIBILITY_CHANGE_EVENT_MASK      = 1 << 16;
  public static final int STRUCTURE_NOTIFY_EVENT_MASK       = 1 << 17;
  public static final int RESIZE_REDIRECT_EVENT_MASK        = 1 << 18;
  public static final int SUBSTRUCTURE_NOTIFY_EVENT_MASK    = 1 << 19;
  public static final int SUBSTRUCTURE_REDIRECT_EVENT_MASK  = 1 << 20;
  public static final int FOCUS_CHANGE_EVENT_MASK           = 1 << 21;
  public static final int PROPERTY_CHANGE_EVENT_MASK        = 1 << 22;
  public static final int COLORMAP_CHANGE_EVENT_MASK        = 1 << 23;
  public static final int OWNER_GRAB_BUTTON_EVENT_MASK      = 1 << 24;

/* Event related constants */

  public static final int NOTIFY_ANCESTOR           = 0;
  public static final int NOTIFY_VIRTUAL            = 1;
  public static final int NOTIFY_INFERIOR           = 2;
  public static final int NOTIFY_NONLINEAR          = 3;
  public static final int NOTIFY_NONLINEAR_VIRTUAL  = 4;


/* Available cursors in X cursor font */
...
/* Keyboard related constants */
  public static final int KEYBOARD_MODIFIERS_COUNT = 8;
  public static final int KEYSYMS_PER_KEYCODE      = 4;

  public static final int SHIFT_KEY_INDEX         = 0;
  public static final int LOCK_KEY_INDEX          = 1;
  public static final int CONTROL_KEY_INDEX       = 2;
  public static final int MOD1_KEY_INDEX          = 3;
  public static final int MOD2_KEY_INDEX          = 4;
  public static final int MOD3_KEY_INDEX          = 5;
  public static final int MOD4_KEY_INDEX          = 6;
  public static final int MOD5_KEY_INDEX          = 7;

  public static final int SHIFT_KEY_MASK           = 1 << 0;
  public static final int LOCK_KEY_MASK            = 1 << 1;
  public static final int CONTROL_KEY_MASK         = 1 << 2;
  public static final int MOD1_KEY_MASK            = 1 << 3;
  public static final int MOD2_KEY_MASK            = 1 << 4;
  public static final int MOD3_KEY_MASK            = 1 << 5;
  public static final int MOD4_KEY_MASK            = 1 << 6;
  public static final int MOD5_KEY_MASK            = 1 << 7;
...
/* Keycodes */
  ...
  public static final int XK_BackSpace      = 0xFF08; //back space
...
/* I do not currently need the whole table */

/*

  public static final int XK_NoSymbol = 0;   
